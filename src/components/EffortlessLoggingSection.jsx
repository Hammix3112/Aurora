...
export default function EffortlessLoggingSection() {
  ...
  return (
    <section aria-label="Effortless Food Logging Section" className="relative w-full bg-[#F7F4EE] text-slate-900 py-24 overflow-hidden perspective-1200 preserve-3d">
      ...
      <div className="absolute left-1/3 top-6 w-32 h-32 pointer-events-none opacity-40">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10 preserve-3d">
        ...
        >
          ...
          <motion.div
            ...
            className="flex items-center gap-3 relative group preserve-3d cursor-pointer"
          >
            ...
            <div className="bg-white/90 backdrop-blur-md border border-purple-200/80 rounded-2xl p-2.5 px-3 shadow-md flex-1 text-center space-y-1 group-hover:border-purple-400 group-hover:shadow-lg group-hover:-translate-y-1 transition-all duration-300">
          ...
          >
            ...
            <div className="relative w-20 h-20 rounded-2xl overflow-hidden shadow-lg border-2 border-white shrink-0 group-hover:scale-105 group-hover:shadow-xl transition-all duration-300">
              <img
          ...
          >
            ...
            <div className="bg-white/90 backdrop-blur-md border border-cyan-200/80 rounded-2xl p-2.5 px-3 shadow-md flex-1 text-left group-hover:border-cyan-400 group-hover:shadow-lg group-hover:-translate-y-1 transition-all duration-300">
