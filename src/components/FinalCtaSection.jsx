...
export default function FinalCtaSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-around max-w-2xl mx-auto w-full mb-8 px-6 preserve-3d">
        {/* Food */}
        <motion.div
          animate={{ y: [-3, 3, -3] }}
        ...
        >
          <div className="w-10 h-10 rounded-full bg-slate-900/90 border border-amber-500/30 flex items-center justify-center text-amber-400 group-hover:border-amber-400 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-amber-950/20">
        ...
        <motion.div
          ...
          className="flex flex-col items-center gap-1.5 group cursor-pointer"
        >
          <div className="w-10 h-10 rounded-full bg-slate-900/90 border border-purple-500/30 flex items-center justify-center text-purple-400 group-hover:border-purple-400 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-purple-950/20">
        ...
        <motion.div
          ...
          className="flex flex-col items-center gap-1.5 group cursor-pointer"
        >
          <div className="w-10 h-10 rounded-full bg-slate-900/90 border border-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:border-cyan-400 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-cyan-950/20">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4 preserve-3d">
            <button
              ...
              className="glow-btn-lime px-8 py-3.5 rounded-full font-grotesk font-semibold text-sm flex items-center gap-2 group transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.03] focus:outline-none focus:ring-2 focus:ring-lime-300"
            >
              Join the beta
            ...
            <button
              ...
              className="dark-pill-btn px-8 py-3.5 rounded-full font-grotesk font-medium text-sm text-slate-200 flex items-center gap-2 group transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.03] focus:outline-none focus:ring-2 focus:ring-purple-400"
            >
              Explore Aurora
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" aria-hidden="true" />
            </button>
