...
export default function PhoneMockup({ children, time = '11:42', battery = '100%' }) {
  return (
    <div className="relative mx-auto w-[290px] sm:w-[320px] h-[580px] sm:h-[620px] select-none group transition-transform duration-500 hover:scale-[1.01]" style={{ perspective: '1200px' }}>
      {/* Outer Glow Halo */}
      <div className="absolute -inset-4 bg-gradient-to-tr from-purple-600/30 via-cyan-500/20 to-teal-400/20 rounded-[52px] blur-2xl opacity-75 group-hover:opacity-100 transition-opacity pointer-events-none"></div>

      {/* Phone Case Frame */}
      <div className="relative w-full h-full bg-[#161B2E] p-2.5 rounded-[46px] shadow-2xl shadow-black border border-slate-700/80 flex flex-col justify-between overflow-hidden" style={{ transform: 'rotateY(-5deg) rotateX(2deg)', transformStyle: 'preserve-3d' }}>
